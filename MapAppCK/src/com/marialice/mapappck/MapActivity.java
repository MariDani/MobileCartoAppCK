...
public class MapActivity extends FragmentActivity implements
	...
	private void addMarkersToMap() {
		...
		mMap.addMarker(new MarkerOptions()
				...
				.anchor(0.5f, 0.5f).rotation(315).title("Lazebnický most")
		...
		mMap.addMarker(new MarkerOptions()
				...
				.anchor(0.5f, 0.5f).rotation(350).title("Plášový most")
		...
		mMap.addMarker(new MarkerOptions()
				...
				.anchor(0.5f, 0.5f).rotation(355).title("Zámecká vìž").snippet("Castle Tower")
				.infoWindowAnchor(0.5f, 0.5f));
